...
parser.add_argument("--clda", type=float,
                    help="intensity of CLDA (= 1. - alpha_CLDA, according to my older notation)", default=0.)
...
DATADIR = "../data/bci-with-feedback-nonstop"
RESULTDIR = "../results/bci-with-feedback-nonstop"
...
epochs = 2000
lambda_ctrl = 0.
loss_fn = EndLoss(params['gamma_v'], params['gamma_f'], lambda_ctrl, 0., params['dt'])
